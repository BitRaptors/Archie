...
```bash
rm -f /tmp/archie_sub*_$PROJECT_NAME.json /tmp/archie_rules_$PROJECT_NAME.json /tmp/archie_intent_prompt_${PROJECT_NAME}_*.txt /tmp/archie_enrichment_${PROJECT_NAME}_*.json
```
