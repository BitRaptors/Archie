...
The viewer renders the same React UI the share flow uses (`archie-viewer.vercel.app`). It works against whatever data exists — health scores, findings, rules, and the architecture diagram all render from `/archie-deep-scan` artifacts.
