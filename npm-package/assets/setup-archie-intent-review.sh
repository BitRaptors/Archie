...
echo "  3. The Action posts FYI comments on the PR:"
echo "       - Intent Review: did the blueprint/rules fold weaken an invariant?"
echo "       - Delivery Review: did the change build the intent (PR title/body) and not break anything?"
echo ""
