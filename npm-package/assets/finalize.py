...
def finalize(root: Path, agent_x_file: str | None = None):
    ...
    # ── 5. Rules — skipped ──────────────────────────────────────────────────
    # Enforcement rules are now generated by an AI synthesis step (Step 7.5 in archie-init).
    # The deterministic rules.py extraction is replaced by AI-produced rules.json.
