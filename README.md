...
**Claude Code reads your code. Archie understands your architecture.**
...
| `get_repository_blueprint` | Get the full Archie blueprint JSON |
...
This keeps your architecture docs current as you code. The Archie blueprint itself is never regenerated by hooks. Only the CLAUDE.md files get re-rendered from the existing blueprint. If your architecture fundamentally changes, re-analyze from the UI.
